...
const invitees=endpoint(async req=>({members:await callService.listEligibleInvitees(req.params.callId,req.user.id)}));
...
module.exports={history,active,details,invitees,iceServers,sendError};
